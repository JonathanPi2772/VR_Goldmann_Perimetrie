...
typedef enum {
    ...
    WVR_FoveationMode_Default = 0x0002,           /**< **WVR_FoveationMode_Default**: Fixed default config depending on the device. Using @ref WVR_IsRenderFoveationDefaultOn and @ref WVR_GetFoveationDefaultConfig to query details. */
    WVR_FoveationMode_Dynamic = 0x0003,           /**< **WVR_FoveationMode_Dynamic**: Similar to default mode, but config will dynamically change due to HMD motion or eye tracking data while eye tracking module is enabled. */
} WVR_FoveationMode;
...
/**
 * @brief Function to set rendering frame rate.
 *
 * Use this function to set rendering frame rate if HMD device supported.
 ...
 * @retval WVR_SUCCESS Set frame rate success, otherwise returns false.
 * @retval WVR_Error_RuntimeVersionNotSupport This feature is supported from Runtime version 12 or higher.
 * @retval WVR_Error_FeatureNotSupport This feature is not supported on this device.
 * @retval WVR_Error_SystemInvalid The runtime initialization was not finished.
 * @retval Others Failed, please see @ref WVR_Result for more information.
*/
extern WVR_EXPORT WVR_Result WVR_SetFrameRate(uint32_t frameRate);

/**
 * @brief Function to get rendering frame rate.
 *
 * Use this function to get rendering frame rate.
 * This function must be called after calling @ref WVR_RenderInit().
 *
 * @version API Level 12
 * @note Supported since Runtime version 12 or higher.
 * @param frameRate A pointer to an unsigned integer of current rendering frame rate.
 * @retval WVR_SUCCESS Get frame rate success, otherwise returns false.
 * @retval WVR_Error_RuntimeVersionNotSupport This feature is supported from Runtime version 12 or higher.
 * @retval WVR_Error_FeatureNotSupport This feature is not supported on this device.
 * @retval WVR_Error_SystemInvalid The runtime initialization was not finished.
 * @retval Others Failed, please see @ref WVR_Result for more information.
*/
extern WVR_EXPORT WVR_Result WVR_GetFrameRate(uint32_t *frameRate);

/**
 * @brief Function to get available frame rates.
 *
 * Use this function to get available frame rates for the HMD.
  *
 * @version API Level 12
 * @note Supported since Runtime version 12 or higher.
 * @param frameRateCapacityInput The capacity of the availableFrameRates array, or 0 to indicate a request to retrieve the required capacity.
 * @param frameRateCountOutput A pointer to the count of availableFrameRates written, or a pointer to the required capacity in the case that frameRateCapacityInput is insufficient.
 * @param availableFrameRates A pointer to an array of integer HMD available frame rates. It can be NULL if frameRateCapacityInput is 0.
 * @retval WVR_SUCCESS Get available frame rates successfully.
 * @retval WVR_Error_RuntimeVersionNotSupport This feature is supported from Runtime version 12 or higher.
 * @retval WVR_Error_FeatureNotSupport This feature is not supported on this device.
 * @retval WVR_Error_SystemInvalid The runtime initialization was not finished.
 * @retval Others Failed, please see @ref WVR_Result for more information.
*/
extern WVR_EXPORT WVR_Result WVR_GetAvailableFrameRates(uint32_t frameRateCapacityInput, uint32_t* frameRateCountOutput, uint32_t *availableFrameRates);
